...
export class LinearVesting extends ethereum.SmartContract {
  ...
  decimals(tokenId_: BigInt): i32 {
    const result = super.call("decimals", "decimals(uint256):(uint8)", [
  ...
  try_decimals(tokenId_: BigInt): ethereum.CallResult<i32> {
    const result = super.tryCall("decimals", "decimals(uint256):(uint8)", [
      ethereum.Value.fromUnsignedBigInt(tokenId_),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  name(tokenId_: BigInt): string {
    const result = super.call("name", "name(uint256):(string)", [
      ethereum.Value.fromUnsignedBigInt(tokenId_),
    ]);
  ...
  try_name(tokenId_: BigInt): ethereum.CallResult<string> {
    const result = super.tryCall("name", "name(uint256):(string)", [
      ethereum.Value.fromUnsignedBigInt(tokenId_),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  symbol(tokenId_: BigInt): string {
    const result = super.call("symbol", "symbol(uint256):(string)", [
      ethereum.Value.fromUnsignedBigInt(tokenId_),
    ]);
  ...
  try_symbol(tokenId_: BigInt): ethereum.CallResult<string> {
    const result = super.tryCall("symbol", "symbol(uint256):(string)", [
      ethereum.Value.fromUnsignedBigInt(tokenId_),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  validate(underlyingToken_: Address, params_: Bytes): boolean {
    const result = super.call("validate", "validate(address,bytes):(bool)", [
      ethereum.Value.fromAddress(underlyingToken_),
      ethereum.Value.fromBytes(params_),
    ]);
  ...
  try_validate(
    ...
    const result = super.tryCall("validate", "validate(address,bytes):(bool)", [
      ethereum.Value.fromAddress(underlyingToken_),
      ethereum.Value.fromBytes(params_),
    ]);
    if (result.reverted) {
