...
export class FixedPriceBatch__claimBidsResultBidClaimsStruct extends ethereum.Tuple {
  get bidder(): Address {
...
export class FixedPriceBatch__claimBidsResult {
  value0: Array<FixedPriceBatch__claimBidsResultBidClaimsStruct>;
  value1: Bytes;
  ...
  getBidClaims(): Array<FixedPriceBatch__claimBidsResultBidClaimsStruct> {
    return this.value0;
  }
...
export class FixedPriceBatch__getAuctionDataResultAuctionData_Struct extends ethereum.Tuple {
  get price(): BigInt {
...
export class FixedPriceBatch__getBidResultBidStruct extends ethereum.Tuple {
  get bidder(): Address {
    return this[0].toAddress();
  }
...
export class FixedPriceBatch__getBidClaimResultBidClaimStruct extends ethereum.Tuple {
  get bidder(): Address {
    return this[0].toAddress();
  }
...
export class FixedPriceBatch__getLotResultValue0Struct extends ethereum.Tuple {
  get start(): BigInt {
    return this[0].toBigInt();
  }
...
export class FixedPriceBatch__getPartialFillResultPartialFillStruct extends ethereum.Tuple {
  get bidId(): BigInt {
    return this[0].toBigInt();
  }
...
export class FixedPriceBatch__getPartialFillResult {
  value0: boolean;
  value1: FixedPriceBatch__getPartialFillResultPartialFillStruct;
  ...
  getPartialFill(): FixedPriceBatch__getPartialFillResultPartialFillStruct {
    return this.value1;
  }
}

export class FixedPriceBatch__lotDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: i32;
  value3: i32;
...
export class FixedPriceBatch__settleResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class FixedPriceBatch extends ethereum.SmartContract {
  static bind(address: Address): FixedPriceBatch {
    return new FixedPriceBatch("FixedPriceBatch", address);
  }
  ...
  claimBids(
  ...
  ): FixedPriceBatch__claimBidsResult {
    let result = super.call(
      "claimBids",
    ...
    return new FixedPriceBatch__claimBidsResult(
      result[0].toTupleArray<FixedPriceBatch__claimBidsResultBidClaimsStruct>(),
      result[1].toBytes(),
    );
  }
  ...
  try_claimBids(
    lotId_: BigInt,
    bidIds_: Array<BigInt>,
  ): ethereum.CallResult<FixedPriceBatch__claimBidsResult> {
    let result = super.tryCall(
      "claimBids",
      "claimBids(uint96,uint64[]):((address,address,uint256,uint256,uint256)[],bytes)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new FixedPriceBatch__claimBidsResult(
        value[0].toTupleArray<FixedPriceBatch__claimBidsResultBidClaimsStruct>(),
        value[1].toBytes(),
      ),
    );
  }
  ...
  getAuctionData(
    lotId_: BigInt,
  ): FixedPriceBatch__getAuctionDataResultAuctionData_Struct {
    let result = super.call(
      "getAuctionData",
    ...
    return changetype<FixedPriceBatch__getAuctionDataResultAuctionData_Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getAuctionData(
    lotId_: BigInt,
  ): ethereum.CallResult<FixedPriceBatch__getAuctionDataResultAuctionData_Struct> {
    let result = super.tryCall(
      "getAuctionData",
      "getAuctionData(uint96):((uint256,uint8,uint64,bool,uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(lotId_)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<FixedPriceBatch__getAuctionDataResultAuctionData_Struct>(
        value[0].toTuple(),
      ),
    );
  }
  ...
  getBid(
    ...
    return changetype<FixedPriceBatch__getBidResultBidStruct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getBid(
    lotId_: BigInt,
    bidId_: BigInt,
  ): ethereum.CallResult<FixedPriceBatch__getBidResultBidStruct> {
    let result = super.tryCall(
      "getBid",
      "getBid(uint96,uint64):((address,uint96,address,uint8))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<FixedPriceBatch__getBidResultBidStruct>(value[0].toTuple()),
    );
  }
  ...
  getBidClaim(
    lotId_: BigInt,
    bidId_: BigInt,
  ): FixedPriceBatch__getBidClaimResultBidClaimStruct {
    let result = super.call(
      "getBidClaim",
    ...
    return changetype<FixedPriceBatch__getBidClaimResultBidClaimStruct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getBidClaim(
    lotId_: BigInt,
    bidId_: BigInt,
  ): ethereum.CallResult<FixedPriceBatch__getBidClaimResultBidClaimStruct> {
    let result = super.tryCall(
      "getBidClaim",
      "getBidClaim(uint96,uint64):((address,address,uint256,uint256,uint256))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<FixedPriceBatch__getBidClaimResultBidClaimStruct>(
        value[0].toTuple(),
      ),
    );
  }

  getBidIdAtIndex(param0: BigInt, param1: BigInt): BigInt {
    let result = super.call(
      "getBidIdAtIndex",
  ...
  getBidIds(param0: BigInt, param1: BigInt, param2: BigInt): Array<BigInt> {
    let result = super.call(
      "getBidIds",
  ...
  getLot(lotId_: BigInt): FixedPriceBatch__getLotResultValue0Struct {
    let result = super.call(
      "getLot",
    ...
    return changetype<FixedPriceBatch__getLotResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getLot(
    lotId_: BigInt,
  ): ethereum.CallResult<FixedPriceBatch__getLotResultValue0Struct> {
    let result = super.tryCall(
      "getLot",
      "getLot(uint96):((uint48,uint48,uint8,uint8,bool,uint256,uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(lotId_)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<FixedPriceBatch__getLotResultValue0Struct>(value[0].toTuple()),
    );
  }

  getNumBids(param0: BigInt): BigInt {
  ...
  try_getNumBids(param0: BigInt): ethereum.CallResult<BigInt> {
  ...
  getPartialFill(lotId_: BigInt): FixedPriceBatch__getPartialFillResult {
    let result = super.call(
      "getPartialFill",
    ...
    return new FixedPriceBatch__getPartialFillResult(
      result[0].toBoolean(),
      changetype<FixedPriceBatch__getPartialFillResultPartialFillStruct>(
        result[1].toTuple(),
      ),
    );
  }
  ...
  try_getPartialFill(
    lotId_: BigInt,
  ): ethereum.CallResult<FixedPriceBatch__getPartialFillResult> {
    let result = super.tryCall(
      "getPartialFill",
      "getPartialFill(uint96):(bool,(uint64,uint96,uint256))",
      [ethereum.Value.fromUnsignedBigInt(lotId_)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FixedPriceBatch__getPartialFillResult(
        value[0].toBoolean(),
        changetype<FixedPriceBatch__getPartialFillResultPartialFillStruct>(
          value[1].toTuple(),
        ),
  ...
  lotData(id: BigInt): FixedPriceBatch__lotDataResult {
    let result = super.call(
      "lotData",
    ...
    return new FixedPriceBatch__lotDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toI32(),
  ...
  try_lotData(id: BigInt): ethereum.CallResult<FixedPriceBatch__lotDataResult> {
    let result = super.tryCall(
      "lotData",
      "lotData(uint96):(uint48,uint48,uint8,uint8,bool,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(id)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FixedPriceBatch__lotDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toI32(),
  ...
  settle(lotId_: BigInt, num_: BigInt): FixedPriceBatch__settleResult {
    let result = super.call(
      "settle",
    ...
    return new FixedPriceBatch__settleResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean(),
  ...
  try_settle(
    lotId_: BigInt,
    num_: BigInt,
  ): ethereum.CallResult<FixedPriceBatch__settleResult> {
    let result = super.tryCall(
      "settle",
      "settle(uint96,uint256):(uint256,uint256,uint256,bool,bytes)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FixedPriceBatch__settleResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBoolean(),
