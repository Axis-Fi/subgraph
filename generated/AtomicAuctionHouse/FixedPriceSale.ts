...
export class FixedPriceSale__auctionDataResult {
  value0: BigInt;
  value1: BigInt;
...
export class FixedPriceSale__getLotResultValue0Struct extends ethereum.Tuple {
  get start(): BigInt {
...
export class FixedPriceSale__lotDataResult {
  value0: BigInt;
  value1: BigInt;
  value2: i32;
  value3: i32;
...
export class FixedPriceSale__purchaseResult {
  value0: BigInt;
  value1: Bytes;
...
export class FixedPriceSale extends ethereum.SmartContract {
  ...
  auctionData(lotId: BigInt): FixedPriceSale__auctionDataResult {
    let result = super.call(
      "auctionData",
      "auctionData(uint96):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(lotId)],
    );

    return new FixedPriceSale__auctionDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
    );
  }
  ...
  try_auctionData(
    lotId: BigInt,
  ): ethereum.CallResult<FixedPriceSale__auctionDataResult> {
    ...
    return ethereum.CallResult.fromValue(
      new FixedPriceSale__auctionDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
      ),
    );
  ...
  getLot(lotId_: BigInt): FixedPriceSale__getLotResultValue0Struct {
    let result = super.call(
      "getLot",
    ...
    return changetype<FixedPriceSale__getLotResultValue0Struct>(
      result[0].toTuple(),
    );
  }
  ...
  try_getLot(
    lotId_: BigInt,
  ): ethereum.CallResult<FixedPriceSale__getLotResultValue0Struct> {
    let result = super.tryCall(
      "getLot",
      "getLot(uint96):((uint48,uint48,uint8,uint8,bool,uint256,uint256,uint256))",
      [ethereum.Value.fromUnsignedBigInt(lotId_)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<FixedPriceSale__getLotResultValue0Struct>(value[0].toTuple()),
    );
  }
  ...
  lotData(id: BigInt): FixedPriceSale__lotDataResult {
    let result = super.call(
      "lotData",
    ...
    return new FixedPriceSale__lotDataResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toI32(),
  ...
  try_lotData(id: BigInt): ethereum.CallResult<FixedPriceSale__lotDataResult> {
    let result = super.tryCall(
      "lotData",
      "lotData(uint96):(uint48,uint48,uint8,uint8,bool,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(id)],
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FixedPriceSale__lotDataResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toI32(),
  ...
  maxPayout(lotId_: BigInt): BigInt {
    let result = super.call("maxPayout", "maxPayout(uint96):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(lotId_),
    ]);
  ...
  try_maxPayout(lotId_: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("maxPayout", "maxPayout(uint96):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(lotId_),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  priceFor(lotId_: BigInt, payout_: BigInt): BigInt {
    let result = super.call("priceFor", "priceFor(uint96,uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(lotId_),
  ...
  purchase(
    ...
    amount_: BigInt,
    auctionData_: Bytes,
  ): FixedPriceSale__purchaseResult {
    let result = super.call(
      "purchase",
    ...
    return new FixedPriceSale__purchaseResult(
      result[0].toBigInt(),
      result[1].toBytes(),
    );
  }
  ...
  try_purchase(
    ...
    amount_: BigInt,
    auctionData_: Bytes,
  ): ethereum.CallResult<FixedPriceSale__purchaseResult> {
    let result = super.tryCall(
      "purchase",
      "purchase(uint96,uint256,bytes):(uint256,bytes)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FixedPriceSale__purchaseResult(
        value[0].toBigInt(),
        value[1].toBytes(),
      ),
    );
