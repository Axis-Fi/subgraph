...
export class AtomicAuctionHouse__multiPurchaseInputParams_Struct extends ethereum.Tuple {
...
export class AtomicAuctionHouse extends ethereum.SmartContract {
  ...
  multiPurchase(
    params_: Array<AtomicAuctionHouse__multiPurchaseInputParams_Struct>,
    callbackData_: Array<Bytes>,
  ): Array<BigInt> {
    let result = super.call(
      "multiPurchase",
      "multiPurchase((address,address,uint96,uint256,uint256,bytes,bytes)[],bytes[]):(uint256[])",
      [
        ethereum.Value.fromTupleArray(params_),
        ethereum.Value.fromBytesArray(callbackData_),
      ],
    );
...
export class MultiPurchaseCall extends ethereum.Call {
  get inputs(): MultiPurchaseCall__Inputs {
    return new MultiPurchaseCall__Inputs(this);
  }

  get outputs(): MultiPurchaseCall__Outputs {
    return new MultiPurchaseCall__Outputs(this);
  }
}

export class MultiPurchaseCall__Inputs {
  _call: MultiPurchaseCall;

  constructor(call: MultiPurchaseCall) {
    this._call = call;
  }

  get params_(): Array<MultiPurchaseCallParams_Struct> {
    return this._call.inputValues[0].value.toTupleArray<MultiPurchaseCallParams_Struct>();
  }

  get callbackData_(): Array<Bytes> {
    return this._call.inputValues[1].value.toBytesArray();
  }
}

export class MultiPurchaseCall__Outputs {
  _call: MultiPurchaseCall;
  ...
  get payoutAmounts(): Array<BigInt> {
    return this._call.outputValues[0].value.toBigIntArray();
  }
}

export class MultiPurchaseCallParams_Struct extends ethereum.Tuple {
  get recipient(): Address {
    return this[0].toAddress();
  }
